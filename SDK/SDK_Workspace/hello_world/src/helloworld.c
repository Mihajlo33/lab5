...
int main()
{
    ...
    unsigned char c = 'C';
    int fore_value = 0x000000;
    int back_value = 0x00E6E6;
    ...
    set_foreground_color(XPAR_VGA_PERIPH_MEM_0_S_AXI_MEM0_BASEADDR, fore_value);
    set_background_color(XPAR_VGA_PERIPH_MEM_0_S_AXI_MEM0_BASEADDR, back_value);
